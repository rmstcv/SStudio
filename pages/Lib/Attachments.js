...
Имена файлов в архиве при выгрузке имеют такой формат:

ID из массива_код вопроса_уникальный код.расширение

Для идентификации по ID из массива нужно включить чекбокс Добавить цифровые идентификаторы к цифро-буквенным в выгрузке самого массива.
